...
public class GenLayerCretaceousEarlyRiverMixDeep extends GenLayer
{
    private final GenLayer biomePatternGeneratorChain;
    private final GenLayer riverPatternGeneratorChain;

    public Biome CRETACEOUS_EARLY_RIVER = Biome.REGISTRY.getObject(new ResourceLocation("minecraft:ocean"));
...
//    public int CRETACEOUS_EARLY_ISLANDS_LARGE_WET_ID =  Biome.getIdForBiome(CRETACEOUS_EARLY_ISLANDS_LARGE_WET);
    ...
    public GenLayerCretaceousEarlyRiverMixDeep(long p_i2129_1_, GenLayer p_i2129_3_, GenLayer p_i2129_4_)
    {
        super(p_i2129_1_);
