...
public class GenLayerCretaceousEarlyYixianRim extends GenLayer
{
    ...
    public GenLayerCretaceousEarlyYixianRim(long seed, GenLayer genLayer)
    {
        super(seed);
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (k != ASIA_YIXIAN_LAKES_A_ID && k != ASIA_YIXIAN_LAKES_B_ID && k != ASIA_YIXIAN_HIGHLAND_ID && k != ASIA_YIXIAN_MOUNTAINS_ID)
                {
                    ...
                    if ((l1 == ASIA_YIXIAN_LAKES_A_ID || l1 == ASIA_YIXIAN_LAKES_B_ID)
                            || (k2 == ASIA_YIXIAN_LAKES_A_ID || k2 == ASIA_YIXIAN_LAKES_B_ID)
                            || (j3 == ASIA_YIXIAN_LAKES_A_ID || j3 == ASIA_YIXIAN_LAKES_B_ID)
                            || (i4 == ASIA_YIXIAN_LAKES_A_ID || i4 == ASIA_YIXIAN_LAKES_B_ID)
                    )
                    {
                ...
                else if (k == ASIA_YIXIAN_LAKES_A_ID)
                    {
                        int l1 = aint[j + 1 + (i + 1 - 1) * (areaWidth + 2)];
                        int k2 = aint[j + 1 + 1 + (i + 1) * (areaWidth + 2)];
                        int j3 = aint[j + 1 - 1 + (i + 1) * (areaWidth + 2)];
                        ...
                        if ((l1 == ASIA_YIXIAN_LAKES_A_ID)
                                && (k2 == ASIA_YIXIAN_LAKES_A_ID)
                                && (j3 == ASIA_YIXIAN_LAKES_A_ID)
                                && (i4 == ASIA_YIXIAN_LAKES_A_ID)
                        )
                        {
                            aint1[j + i * areaWidth] = VariantBiomes2[nextInt(VariantBiomes2.length)];}
                        else {
                            aint1[j + i * areaWidth] = k;
                        }
                }
                else if (k == ASIA_YIXIAN_LAKES_B_ID)
                {
                    int l1 = aint[j + 1 + (i + 1 - 1) * (areaWidth + 2)];
                    int k2 = aint[j + 1 + 1 + (i + 1) * (areaWidth + 2)];
                    int j3 = aint[j + 1 - 1 + (i + 1) * (areaWidth + 2)];
                    ...
                    if ((l1 == ASIA_YIXIAN_LAKES_B_ID)
                            && (k2 == ASIA_YIXIAN_LAKES_B_ID)
                            && (j3 == ASIA_YIXIAN_LAKES_B_ID)
                            && (i4 == ASIA_YIXIAN_LAKES_B_ID)
                    )
                    {
                        aint1[j + i * areaWidth] = VariantBiomes3[nextInt(VariantBiomes3.length)];}
                    else {
                        aint1[j + i * areaWidth] = k;
                    }
                }
