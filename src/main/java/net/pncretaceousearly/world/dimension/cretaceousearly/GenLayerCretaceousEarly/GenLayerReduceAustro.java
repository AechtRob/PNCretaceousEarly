...
public class GenLayerReduceAustro extends GenLayer
{
    ...
    public int CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA_ID =  Biome.getIdForBiome(CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA);
    ...
    private final int AustroBiomeShrink[] = new int[] {
            CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA_ID,
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (k == CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA_ID)
                {
                    ...
                    boolean flag = (
                        (
                        (l1 != CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA_ID)
                            || (k2 != CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA_ID)
                            || (j3 != CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA_ID)
                            || (i4 != CRETACEOUS_EARLY_AUSTRALIA_ANTARCTICA_ID)
                        )
                    );
                    if (flag)
                    {
