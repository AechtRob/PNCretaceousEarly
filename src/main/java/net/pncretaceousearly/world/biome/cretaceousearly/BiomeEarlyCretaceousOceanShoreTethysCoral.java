...
public class BiomeEarlyCretaceousOceanShoreTethysCoral extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_ocean_shore_tethys_coral")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousOceanShoreTethysCoral(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous Tethys Ocean Coral Reefs").setRainfall(0.5F).setBaseHeight(-0.55F).setHeightVariation(0.125F));
			setRegistryName("lepidodendron:cretaceous_early_ocean_shore_tethys_coral");
