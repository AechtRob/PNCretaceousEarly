...
public class BiomeEarlyCretaceousLandAfricaSavanna extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_africa_savanna")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAfricaSavanna(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana Africa Ruddy Savanna").setRainfall(0.0F).setBaseHeight(0.62F).setHeightVariation(0.02F).setTemperature(1.8F).setRainDisabled());
			setRegistryName("lepidodendron:cretaceous_early_africa_savanna");
