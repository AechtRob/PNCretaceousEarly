...
public class BiomeEarlyCretaceousLandAsiaYixianMountains extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_yixian_mountains")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAsiaYixianMountains(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous Asia Storied Peaks").setBaseHeight(9.95F).setHeightVariation(0.8F).setTemperature(0.345F));
