...
public class BiomeEarlyCretaceousCreekBeachAsia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_beach_asia")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekBeachAsia(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
