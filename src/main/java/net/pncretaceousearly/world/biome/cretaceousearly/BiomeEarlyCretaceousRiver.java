...
public class BiomeEarlyCretaceousRiver extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_river")
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic River").setBaseHeight(-0.76F).setHeightVariation(0.0F).setTemperature(1.0F).setRainfall(0.5F));
			setRegistryName("lepidodendron:jurassic_river");
