...
public class BiomeEarlyCretaceousLandAustroAntarcticCraterRim extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_australia_antarctica_crater_rim")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAustroAntarcticCraterRim(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous East Gondwana Overgrown Hole").setRainfall(0.0F).setBaseHeight(0.5F).setHeightVariation(0.0F).setTemperature(2.0F).setRainDisabled());
			setRegistryName("lepidodendron:cretaceous_early_australia_antarctica_crater_rim");
