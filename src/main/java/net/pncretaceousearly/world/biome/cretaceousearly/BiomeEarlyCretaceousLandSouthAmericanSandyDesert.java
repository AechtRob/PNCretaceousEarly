...
public class BiomeEarlyCretaceousLandSouthAmericanSandyDesert extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_samerica_sandy_desert")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandSouthAmericanSandyDesert(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana S. America Sandy Desert").setRainfall(0.0F).setBaseHeight(0.15F).setHeightVariation(0.15F).setTemperature(2.0F).setRainDisabled());
			setRegistryName("lepidodendron:cretaceous_early_samerica_sandy_desert");
		...
		protected static final WorldGenColumnarisTreeDead DEAD_TREE = new WorldGenColumnarisTreeDead(false);
...
//
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 1; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockFrenelopsis.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), Functions.getAdjustedSeaLevel(worldIn, pos.add(j, l, k)) + 4, Functions.getAdjustedSeaLevel(worldIn, pos.add(j, l, k)) + 15,false);
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 24; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					ZAMITES_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), true);
				}
