...
public class BiomeEarlyCretaceousLandAustraliaAntarcticaPodocarpLake extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_australia_antarctica_lakes")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAustraliaAntarcticaPodocarpLake(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous East Gondwana Podocarp Forest Lakes").setBaseHeight(-1.0F).setHeightVariation(0.0005F).setTemperature(1.0F).setRainfall(1.0F));
			setRegistryName("lepidodendron:cretaceous_early_australia_antarctica_lakes");
