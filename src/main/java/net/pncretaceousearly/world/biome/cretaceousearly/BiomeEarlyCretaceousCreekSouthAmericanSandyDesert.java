...
public class BiomeEarlyCretaceousCreekSouthAmericanSandyDesert extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_samerica_sandy_desert")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekSouthAmericanSandyDesert(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
