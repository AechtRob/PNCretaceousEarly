...
public class BiomeEarlyCretaceousCreekNAmericaShrubland extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_namerica_shrubland")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekNAmericaShrubland(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous North American SHRUBLAND Creek").setBaseHeight(-0.50F).setHeightVariation(0.01F).setTemperature(1.5F));
