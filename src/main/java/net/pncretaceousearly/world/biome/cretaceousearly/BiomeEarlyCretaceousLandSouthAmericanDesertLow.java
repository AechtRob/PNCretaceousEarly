...
public class BiomeEarlyCretaceousLandSouthAmericanDesertLow extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_samerica_desert_low")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandSouthAmericanDesertLow(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous SAMERICA LOW").setRainfall(0.0F).setBaseHeight(-0.10F).setHeightVariation(0.00F).setTemperature(2.2F).setRainDisabled().setWaterColor(-10724281));
