...
public class BiomeEarlyCretaceousCreekSouthAmericanPatagonia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_south_america_patagonia")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekSouthAmericanPatagonia(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana S. America Wet Forest Creek").setBaseHeight(-0.525F).setHeightVariation(0.01F).setTemperature(1.7F));
