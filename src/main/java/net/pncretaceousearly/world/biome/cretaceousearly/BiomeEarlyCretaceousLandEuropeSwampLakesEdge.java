...
public class BiomeEarlyCretaceousLandEuropeSwampLakesEdge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_europe_swamp_lakes_edge")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandEuropeSwampLakesEdge(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("EDGE E. Cretaceous European Swampy Lowlands").setBaseHeight(0.115F).setHeightVariation(0.005F).setTemperature(1.1F).setRainfall(0.9F));
			setRegistryName("lepidodendron:cretaceous_early_europe_swamp_lakes_edge");
