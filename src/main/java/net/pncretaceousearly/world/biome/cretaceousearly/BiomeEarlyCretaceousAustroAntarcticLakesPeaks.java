...
public class BiomeEarlyCretaceousAustroAntarcticLakesPeaks extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous East Gondwana Sub-Alpine Lakes").setBaseHeight(3.1F).setHeightVariation(0.125F).setTemperature(0.3F).setRainfall(0.9F));
