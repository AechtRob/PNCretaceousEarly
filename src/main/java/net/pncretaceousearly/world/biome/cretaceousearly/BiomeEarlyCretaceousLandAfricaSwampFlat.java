...
public class BiomeEarlyCretaceousLandAfricaSwampFlat extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_africa_swamp")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAfricaSwampFlat(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous West Gondwana Africa Swampy Woodland").setRainfall(0.5F).setBaseHeight(-0.2F).setHeightVariation(0.02F).setTemperature(1.45F).setRainfall(0.9F).setWaterColor(3906905));
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 2; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockAngiopteris.block.getDefaultState(), worldIn, rand, pos.add(j, l, k));
				}
