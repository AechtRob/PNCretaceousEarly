...
public class BiomeEarlyCretaceousLandEuropeSwampLakes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_europe_swamp_lakes")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandEuropeSwampLakes(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("LAKE E. Cretaceous European Swampy Lowlands").setBaseHeight(-0.50F).setHeightVariation(0.00F).setTemperature(1.1F).setRainfall(0.9F));
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 4; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PARADOXOPTERIS_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), true, false);
				}
