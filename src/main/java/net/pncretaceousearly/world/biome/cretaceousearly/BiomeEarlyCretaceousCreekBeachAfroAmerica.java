...
public class BiomeEarlyCretaceousCreekBeachAfroAmerica extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_beach_africa")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekBeachAfroAmerica(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
