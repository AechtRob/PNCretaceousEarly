...
public class BiomeEarlyCretaceousLandAfricaSavannaWateringHole extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Watering Hole").setRainfall(0.0F).setBaseHeight(0.15F).setHeightVariation(0.00F).setTemperature(1.8F).setRainDisabled());
