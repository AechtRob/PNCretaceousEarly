...
public class BiomeEarlyCretaceousAustroAntarcticCoastalCliffsNoRoost extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_austro_antarctic_coastal_cliffs_noroost")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousAustroAntarcticCoastalCliffsNoRoost(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:cretaceous_early_austro_antarctic_coastal_cliffs_noroost");
