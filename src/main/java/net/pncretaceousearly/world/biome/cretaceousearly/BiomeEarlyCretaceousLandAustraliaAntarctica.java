...
public class BiomeEarlyCretaceousLandAustraliaAntarctica extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_australia_antarctica")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAustraliaAntarctica(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Early Cretaceous Austro-Antarctic Podocarp Forest").setBaseHeight(0.35F).setHeightVariation(0.0125F).setTemperature(0.9F).setRainfall(0.9F));
			setRegistryName("lepidodendron:cretaceous_early_australia_antarctica");
