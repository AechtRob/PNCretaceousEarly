...
public class BiomeEarlyCretaceousLandEuropeField extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_europe_field")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandEuropeField(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Europe Ferny Floodplain").setBaseHeight(-0.115F).setHeightVariation(0.0001F).setTemperature(1.7F));
