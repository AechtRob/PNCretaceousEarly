...
public class BiomeEarlyCretaceousCreekBeachAsiaCraggy extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_beach_asia_craggy")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekBeachAsiaCraggy(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
