...
public class BiomeEarlyCretaceousLandAfrica extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_africa")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAfrica(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Early Cretaceous Africa").setBaseHeight(1.025F).setHeightVariation(0.0425F).setTemperature(0.9F).setRainfall(0.9F));
