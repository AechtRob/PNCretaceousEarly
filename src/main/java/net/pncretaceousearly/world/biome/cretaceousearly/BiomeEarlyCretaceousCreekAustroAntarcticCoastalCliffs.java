...
public class BiomeEarlyCretaceousCreekAustroAntarcticCoastalCliffs extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_austro_antarctic_coastal_cliffs")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAustroAntarcticCoastalCliffs(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous East Gondwana Coastal Cliffs Creek").setBaseHeight(-0.565F).setHeightVariation(0.01F).setTemperature(1.4F));
			setRegistryName("lepidodendron:cretaceous_early_creek_austro_antarctic_coastal_cliffs");
