...
public class BiomeEarlyCretaceousCreekEuropeField extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_europe_field")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekEuropeField(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous Europe Ferny Floodplain Creek").setBaseHeight(-0.65F).setHeightVariation(0.01F).setTemperature(1.7F));
			setRegistryName("lepidodendron:cretaceous_early_creek_europe_field");
