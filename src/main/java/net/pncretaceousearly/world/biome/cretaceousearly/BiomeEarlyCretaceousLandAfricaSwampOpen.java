...
public class BiomeEarlyCretaceousLandAfricaSwampOpen extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_africa_swamp_open")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAfricaSwampOpen(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous West Gondwana Africa Swamp").setRainfall(0.5F).setBaseHeight(-0.15F).setHeightVariation(0.1F).setTemperature(1.45F).setRainfall(0.9F).setWaterColor(3906905));
			setRegistryName("lepidodendron:cretaceous_early_africa_swamp_open");
		...
		protected static final WorldGenCzekanowskiaTree CZEKANOWSKIA_TREE = new WorldGenCzekanowskiaTree(false);
		...
		protected static final WorldGenSandyDirtBlackNearWater SAND_GENERATOR = new WorldGenSandyDirtBlackNearWater();
		...
		protected static final WorldGenTreeLogWater CYPRESS_LOG_GENERATOR = new WorldGenTreeLogWater(BlockCypressLog.block);
		protected static final WorldGenTreeLogWater PODOZAMITES_LOG_GENERATOR = new WorldGenTreeLogWater(BlockPodozamitesLog.block);
		...
		public WorldGenAbstractTree getRandomTreeFeature(Random rand)
		{
			...
			switch (selector) {
				...
				case 4: case 5: case 6: case 7: case 3:
					return TEMPSKYA_TREE;
			}
		}
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
			{
				...
				for (int j = 0; j < i; ++j)
				{
					...
					int l = rand.nextInt(16) + 8;
					BlockPos blockpos = worldIn.getHeight(pos.add(k, 0, l));
					if (Math.random() > 0.5) {PODOZAMITES_LOG_GENERATOR.generate(worldIn, rand, blockpos);}
				}
				i = rand.nextInt(2);
				...
				for (int j = 0; j < i; ++j)
				{
					...
					int l = rand.nextInt(16) + 8;
					BlockPos blockpos = worldIn.getHeight(pos.add(k, 0, l));
					if (Math.random() > 0.5) {SPHENOBAIERA_LOG_GENERATOR.generate(worldIn, rand, blockpos);}
				}
				i = rand.nextInt(2);
				...
				for (int j = 0; j < i; ++j)
				{
					...
					int l = rand.nextInt(16) + 8;
					BlockPos blockpos = worldIn.getHeight(pos.add(k, 0, l));
					if (Math.random() > 0.5) {CYPRESS_LOG_GENERATOR.generate(worldIn, rand, blockpos);}
				}
				i = rand.nextInt(2);
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 24; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockMatonia.block.getDefaultState(), worldIn, rand, pos.add(j, l, k));
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 5; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockLophosoria.block.getDefaultState(), worldIn, rand, pos.add(j, l, k));
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 48; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockChloranthus.block.getDefaultState(), worldIn, rand, pos.add(j, l, k));
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 2; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockConiopteris.block.getDefaultState(), worldIn, rand, pos.add(j, l, k));
				}
