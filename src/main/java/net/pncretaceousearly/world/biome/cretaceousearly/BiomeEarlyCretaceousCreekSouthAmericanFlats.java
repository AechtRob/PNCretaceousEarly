...
public class BiomeEarlyCretaceousCreekSouthAmericanFlats extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_samerica_flats")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekSouthAmericanFlats(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana S. America Coastal Flats Creek").setRainfall(0.0F).setBaseHeight(-0.50F).setHeightVariation(0.01F).setTemperature(1.2F).setRainDisabled());
			setRegistryName("lepidodendron:cretaceous_early_creek_samerica_flats");
...
//					int k = rand.nextInt(16) + 8;
//					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
//					PLANT_GENERATOR.generate(BlockWelwitschiophyllum.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 0, 70, false);
//				}
//
//			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
//				for (int i = 0; i < 24; ++i)
