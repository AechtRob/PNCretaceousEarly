...
public class BiomeEarlyCretaceousBeachEuropeDry extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_beach_europe_dry")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousBeachEuropeDry(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
