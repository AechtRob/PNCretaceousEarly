...
public class BiomeEarlyCretaceousLandAsiaPhryganaLake extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Asia Maritime Scrub Lake").setBaseHeight(-0.95F).setHeightVariation(0.02F).setTemperature(2.0F).setRainfall(0.5F).setWaterColor(-1312465));
