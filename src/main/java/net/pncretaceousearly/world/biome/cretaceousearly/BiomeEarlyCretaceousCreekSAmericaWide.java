...
public class BiomeEarlyCretaceousCreekSAmericaWide extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_south_america_creek_wide")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekSAmericaWide(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana S. America Riparian Wetlands").setBaseHeight(0.001F).setHeightVariation(0.00F).setTemperature(0.9F).setRainfall(0.9F));
		...
		protected static final WorldGenTreeLog PODOZAMITES_LOG_GENERATOR = new WorldGenTreeLog(BlockPodozamitesLog.block);
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
			{
				...
				for (int j = 0; j < i; ++j)
				{
					...
					PODOZAMITES_LOG_GENERATOR.generate(worldIn, rand, blockpos);
				}
			}
