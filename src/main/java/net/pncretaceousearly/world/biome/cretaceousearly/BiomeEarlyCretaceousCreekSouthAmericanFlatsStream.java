...
public class BiomeEarlyCretaceousCreekSouthAmericanFlatsStream extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_samerica_flats_stream")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekSouthAmericanFlatsStream(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
