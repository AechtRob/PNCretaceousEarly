...
public class BiomeEarlyCretaceousLandAsia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_asia")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAsia(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Asia Boggy Glades").setBaseHeight(-0.15F).setHeightVariation(0.02F).setRainfall(1.5F).setTemperature(1.8F).setWaterColor(-7562693));
