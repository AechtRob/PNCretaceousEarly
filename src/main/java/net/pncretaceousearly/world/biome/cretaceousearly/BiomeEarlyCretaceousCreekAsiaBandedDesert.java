...
public class BiomeEarlyCretaceousCreekAsiaBandedDesert extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_banded_desert")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAsiaBandedDesert(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Asia Banded Desert Creek").setBaseHeight(-0.7F).setHeightVariation(0.0F).setTemperature(2.0F).setWaterColor(-5184253).setWaterColor(-11686290));
			setRegistryName("lepidodendron:cretaceous_early_creek_banded_desert");
