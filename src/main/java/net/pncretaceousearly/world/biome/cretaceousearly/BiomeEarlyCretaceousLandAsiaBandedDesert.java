...
public class BiomeEarlyCretaceousLandAsiaBandedDesert extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_banded_desert")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAsiaBandedDesert(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
