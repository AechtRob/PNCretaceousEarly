...
public class BiomeEarlyCretaceousCreekAsiaShrubland extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_shrubland")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAsiaShrubland(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous Bennettites Shrubland Creek").setBaseHeight(-0.525F).setHeightVariation(0.01F).setTemperature(1.0F).setWaterColor(-10776517));
			setRegistryName("lepidodendron:cretaceous_early_creek_shrubland");
