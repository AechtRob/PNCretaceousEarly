...
public class BiomeEarlyCretaceousCreekAsiaShrubland extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous Bennettites Shrubland Creek").setBaseHeight(-0.50F).setHeightVariation(0.0F).setTemperature(1.0F).setWaterColor(-10776517));
