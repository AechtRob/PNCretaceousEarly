...
public class BiomeEarlyCretaceousInlandSeaAustralia extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous East Gondwana Inland Sea").setRainfall(0.5F).setBaseHeight(-1.35F).setHeightVariation(0.078F).setTemperature(0.8F).setWaterColor(-14257600));
