...
public class BiomeEarlyCretaceousLandAfricaBrownstonePeaks extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_africa_peaks")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAfricaBrownstonePeaks(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana Africa Brownstone Mountains").setSnowEnabled().setBaseHeight(5.58F).setHeightVariation(0.245F).setTemperature(0.5F));
