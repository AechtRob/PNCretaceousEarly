...
public class BiomeEarlyCretaceousLandAfricaBrownstonePeaks extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous African Brownstone Mountain Peaks").setSnowEnabled().setBaseHeight(5.58F).setHeightVariation(0.245F).setTemperature(0.5F));
