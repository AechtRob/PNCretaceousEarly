...
public class BiomeEarlyCretaceousLandAsiaShrublandSprings extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_shrubland_springs")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAsiaShrublandSprings(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
