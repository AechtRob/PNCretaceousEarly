...
public class BiomeEarlyCretaceousLandSouthAmericanAridSpikes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_samerica_arid_spikes")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandSouthAmericanAridSpikes(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana S. America Arid Stacks").setRainfall(0.0F).setBaseHeight(2.15F).setHeightVariation(0.025F).setTemperature(1.8F).setRainDisabled());
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.ICE)) {
				{
					...
					for (int j = 0; j < 24; ++j)
					{
						...
						GUANO_GENERATOR.generate(worldIn, rand, blockpos, 94);
					}
				}
			}
...
//						BlockPos blockpos = worldIn.getHeight(pos.add(k, 0, l));
//						blockpos = ChunkGenSpawner.getTopSolidBlock(blockpos, worldIn).up();
//						NEST_GENERATOR.generate(worldIn, rand, blockpos, 94, new EntityPrehistoricFloraKariridraco(worldIn));
//					}
				}
			}
