...
public class BiomeEarlyCretaceousOceanCragsNoRoost extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_ocean_crags_noroost")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousOceanCragsNoRoost(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			...
			setRegistryName("lepidodendron:cretaceous_early_ocean_crags_noroost");
