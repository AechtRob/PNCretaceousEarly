...
public class BiomeEarlyCretaceousLandSouthAmericanSandyDesertSpikes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_samerica_sandy_desert_spikes")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandSouthAmericanSandyDesertSpikes(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
