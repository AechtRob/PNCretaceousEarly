...
public class BiomeEarlyCretaceousCreekAfricaSavanna extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_africa_savanna")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAfricaSavanna(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous African Ruddy Savanna Creek").setRainfall(0.0F).setBaseHeight(-0.40F).setHeightVariation(0.01F).setTemperature(1.8F).setRainDisabled());
