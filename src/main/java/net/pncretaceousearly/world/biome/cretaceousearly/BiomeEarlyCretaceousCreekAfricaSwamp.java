...
public class BiomeEarlyCretaceousCreekAfricaSwamp extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_africa_swamp")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAfricaSwamp(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous West Gondwana Africa Swamp Creek").setRainfall(0.5F).setBaseHeight(-0.50F).setHeightVariation(0.01F).setTemperature(1.45F).setRainfall(0.9F).setWaterColor(3906905));
