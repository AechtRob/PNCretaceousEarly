...
public class BiomeEarlyCretaceousCreekBeachEuropeSwamp extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_beach_europe_swamp")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekBeachEuropeSwamp(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
