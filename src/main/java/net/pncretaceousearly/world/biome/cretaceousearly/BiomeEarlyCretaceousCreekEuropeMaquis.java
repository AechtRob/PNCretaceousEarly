...
public class BiomeEarlyCretaceousCreekEuropeMaquis extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous European Sandy Maquis Creek").setBaseHeight(-0.50F).setHeightVariation(0.01F).setTemperature(1.3F).setRainfall(0.9F));
			setRegistryName("lepidodendron:cretaceous_early_creek_europe_maquis");
		...
		protected static final WorldGenCycadopteris CYCADOPTERIS_TREE = new WorldGenCycadopteris(false);
		...
		protected static final WorldGenMonanthesia MONANTHESIA_GENERATOR = new WorldGenMonanthesia();
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 24; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockErdtmanithecales.block.getDefaultState(), worldIn, rand, pos.add(j, l, k));
				}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 4; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					MONANTHESIA_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
