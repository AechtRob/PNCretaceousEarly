...
public class BiomeEarlyCretaceousCreekAustraliaAntarctica extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_australia_antarctica_creek")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAustraliaAntarctica(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Early Cretaceous Austro-Antarctic Podocarp Forest Creek").setBaseHeight(-0.50F).setHeightVariation(0.01F).setTemperature(0.9F).setRainfall(0.9F));
