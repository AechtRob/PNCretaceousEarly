...
public class BiomeEarlyCretaceousCreekAustraliaAntarctica extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Austro-Antarctic Podocarp Forest Creek").setBaseHeight(-0.50F).setHeightVariation(0.01F).setTemperature(0.9F).setRainfall(0.9F));
