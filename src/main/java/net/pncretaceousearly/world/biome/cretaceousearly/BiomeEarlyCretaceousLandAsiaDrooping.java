...
public class BiomeEarlyCretaceousLandAsiaDrooping extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_asia_drooping_swamp")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAsiaDrooping(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
