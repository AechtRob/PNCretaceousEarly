...
public class BiomeEarlyCretaceousAustroAntarcticCoastal extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_austro_antarctic_coastal")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousAustroAntarcticCoastal(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Austro-Antarctic Coastal Sandbars").setBaseHeight(-0.05F).setHeightVariation(0.00F).setTemperature(1.4F));
			setRegistryName("lepidodendron:cretaceous_early_austro_antarctic_coastal");
