...
public class BiomeEarlyCretaceousLandEuropeFieldCopse extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_europe_field_copse")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandEuropeFieldCopse(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous European Wooded Floodplain").setBaseHeight(0.085F).setHeightVariation(0.0001F).setTemperature(1.7F));
