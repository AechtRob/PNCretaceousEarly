...
public class BiomeEarlyCretaceousOceanTransition extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_ocean_transition")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousOceanTransition(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous Deep Ocean").setBaseHeight(-1.28F).setHeightVariation(0.275F));
			setRegistryName("lepidodendron:cretaceous_early_ocean_transition");
