...
public class BiomeEarlyCretaceousLandEurope extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_europe")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandEurope(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Early Cretaceous European Swampy Lowlands").setBaseHeight(0.015F).setHeightVariation(0.005F).setTemperature(1.1F).setRainfall(0.9F));
