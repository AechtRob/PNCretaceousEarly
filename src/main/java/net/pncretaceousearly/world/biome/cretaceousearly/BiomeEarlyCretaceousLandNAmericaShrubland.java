...
public class BiomeEarlyCretaceousLandNAmericaShrubland extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_namerica_shrubland")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandNAmericaShrubland(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous N. America Shrubland").setBaseHeight(0.3F).setHeightVariation(0.015F).setTemperature(1.5F));
		...
		protected static final WorldGenCedarTree CEDAR_TREE = new WorldGenCedarTree(false);
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 20; ++i)
				{
					...
					PLANT_GENERATOR.generate(BlockBaiera.block.getDefaultState(), worldIn, rand, pos.add(j, l, k), 0, 80);
				}
...
//
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 15; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PLANT_GENERATOR.generate(BlockSapindopsis.block.getDefaultState(), worldIn, rand, ChunkGenSpawner.getTopSolidBlock(pos.add(j, l, k), worldIn).up(), 68, 255);
				}
