...
public class BiomeEarlyCretaceousAustroAntarcticLakes extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Early Cretaceous Austro-Antarctic Sub-Alpine Lakes").setBaseHeight(1.45F).setHeightVariation(0.12125F).setTemperature(0.6F).setRainfall(0.9F));
