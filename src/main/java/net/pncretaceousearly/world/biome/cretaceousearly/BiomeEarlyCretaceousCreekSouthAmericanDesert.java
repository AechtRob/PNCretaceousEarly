...
public class BiomeEarlyCretaceousCreekSouthAmericanDesert extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_south_america_desert")
	public static final BiomeGenCustom biome = null;

	public BiomeEarlyCretaceousCreekSouthAmericanDesert(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			super(new BiomeProperties("E. Cretaceous West Gondwana S. America Xeric Floodplain Creek").setRainfall(0.5F).setBaseHeight(-0.50F).setHeightVariation(0.01F).setWaterColor(-10724281));
			setRegistryName("lepidodendron:cretaceous_early_creek_south_america_desert");
		...
		protected static final WorldGenMonkeyPuzzleAraucariaTree ARAUCARIA_TREE = new WorldGenMonkeyPuzzleAraucariaTree(false);
