...
public class BiomeEarlyCretaceousLandAfricaBrownstonePinnacles extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous African Brownstone Mountain Peaks").setSnowEnabled().setBaseHeight(9.58F).setHeightVariation(0.445F).setTemperature(-0.25F));
