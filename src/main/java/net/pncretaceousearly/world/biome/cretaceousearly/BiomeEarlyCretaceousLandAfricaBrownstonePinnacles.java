...
public class BiomeEarlyCretaceousLandAfricaBrownstonePinnacles extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_africa_pinnacles")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAfricaBrownstonePinnacles(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous West Gondwana Africa Brownstone Mountains").setSnowEnabled().setBaseHeight(9.58F).setHeightVariation(0.445F).setTemperature(-0.25F));
			setRegistryName("lepidodendron:cretaceous_early_africa_pinnacles");
