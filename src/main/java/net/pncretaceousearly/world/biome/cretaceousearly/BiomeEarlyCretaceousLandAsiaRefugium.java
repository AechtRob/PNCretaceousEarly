...
public class BiomeEarlyCretaceousLandAsiaRefugium extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_refugium")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousLandAsiaRefugium(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
