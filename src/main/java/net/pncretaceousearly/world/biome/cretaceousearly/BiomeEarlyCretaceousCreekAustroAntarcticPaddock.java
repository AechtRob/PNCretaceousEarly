...
public class BiomeEarlyCretaceousCreekAustroAntarcticPaddock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_australia_antarctica_paddock")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAustroAntarcticPaddock(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous East Gondwana Paddock Creek").setBaseHeight(-0.525F).setHeightVariation(0.01F).setTemperature(1.0F));
			setRegistryName("lepidodendron:cretaceous_early_creek_australia_antarctica_paddock");
