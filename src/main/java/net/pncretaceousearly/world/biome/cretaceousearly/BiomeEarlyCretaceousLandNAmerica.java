...
public class BiomeEarlyCretaceousLandNAmerica extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous N. America Braided Floodplain").setBaseHeight(0.025F).setHeightVariation(0.0025F).setTemperature(1.9F).setRainfall(0.9F));
