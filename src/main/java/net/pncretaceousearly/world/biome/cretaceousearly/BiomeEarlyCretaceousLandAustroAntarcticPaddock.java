...
public class BiomeEarlyCretaceousLandAustroAntarcticPaddock extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous East Gondwana Paddock").setBaseHeight(0.425F).setHeightVariation(0.0F).setTemperature(1.0F));
		...
		protected static final WorldGenDasypogon DASYPOGON_GENERATOR = new WorldGenDasypogon();
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 24; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					DASYPOGON_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), false);
				}
