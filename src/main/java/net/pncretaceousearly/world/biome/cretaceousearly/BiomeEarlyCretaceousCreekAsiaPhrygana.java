...
public class BiomeEarlyCretaceousCreekAsiaPhrygana extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Coniferous Phrygana Creek").setBaseHeight(-0.20F).setHeightVariation(0.01F).setTemperature(2.0F).setRainfall(0.5F).setWaterColor(-1312465));
