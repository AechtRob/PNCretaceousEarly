...
public class BiomeEarlyCretaceousCreekAsiaPhrygana extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cretaceous_early_creek_asia_phyrgana")
	public static final BiomeGenCustom biome = null;
	public BiomeEarlyCretaceousCreekAsiaPhrygana(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeCretaceousEarly {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("E. Cretaceous Asia Maritime Scrub Creek").setBaseHeight(-0.20F).setHeightVariation(0.01F).setTemperature(2.0F).setRainfall(0.5F).setWaterColor(-1312465));
			setRegistryName("lepidodendron:cretaceous_early_creek_asia_phyrgana");
